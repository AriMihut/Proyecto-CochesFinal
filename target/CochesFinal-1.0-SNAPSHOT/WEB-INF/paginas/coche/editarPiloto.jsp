<html>
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/ServletControlador?accion=modificarPiloto&idPiloto=${piloto.idPiloto}"
        ...
        <!-- Botones de navegación para editar piloto-->
        <jsp:include page="/WEB-INF/paginas/comunes/botonesNavegacionEdicionPilotos.jsp"/>
        </form><!-- comment -->
